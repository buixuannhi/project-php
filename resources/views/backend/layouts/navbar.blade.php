    ...
    <ul class="navbar-nav navbar-align">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
                ...
                <div class="list-group">
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('assets/backend') }}/img/avatars/avatar-5.jpg"
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('assets/backend') }}/img/avatars/avatar-2.jpg"
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('assets/backend') }}/img/avatars/avatar-4.jpg"
                    ...
                    <a href="#" class="list-group-item">
                        <div class="row g-0 align-items-center">
                            <div class="col-2">
                                <img src="{{ asset('assets/backend') }}/img/avatars/avatar-3.jpg"
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                ...
                <a class="dropdown-item" href="#">
                    <img src="{{ asset('assets/backend') }}/img/flags/es.png" alt="Spanish" width="20"
                        class="align-middle me-1" />
                    <span class="align-middle">Spanish</span>
                </a>
                <a class="dropdown-item" href="#">
                    <img src="{{ asset('assets/backend') }}/img/flags/ru.png" alt="Russian" width="20"
                        class="align-middle me-1" />
                    <span class="align-middle">Russian</span>
                </a>
                <a class="dropdown-item" href="#">
                    <img src="{{ asset('assets/backend') }}/img/flags/de.png" alt="German" width="20"
                        class="align-middle me-1" />
